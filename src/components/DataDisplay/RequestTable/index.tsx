...
function RequestTable({
      ...
      (column, index) => {
        return {
          ...
          meta: {
            type: column.type,
            width: column.width,
            align: columns.length - index <= 3 ? 'center' : column.align, // centraliza as últimas três colunas
  ...
  return (
    <Skeleton isLoaded={!isLoading} borderRadius="8px">
      <Box bg="transparent" pb={5} pt={2} px={2} borderRadius="lg">
        <Table>
          <Thead>
